    ...
    <div className="pb-20 pt-36">
        <div>
         ...
         <div className="h-screen w-full dark:bg-black-100
          ...
          top-0 left-0">
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-grid-black-100 bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"/>
      </div>
      ...
      my-20 z-10">
        ...
        justify-center'>
          ...
          text-xs text-center text-blue-100 max-w-80">
            Magic Dinâmica Com Next.js
          </p>
          <TextGenerateEffect 
          words="Transformando Conceitos em Realidade"
          className="text-center text-[40px]
          md:text-5xl lg:text-6xl"
          />
  <p className="text-center md:tracking-wider
  mb-4 text-sm md:text-lg lg:text-2xl ">
  Hi, Im Tony, a Next.js Developer
  based in Brazil
  </p>
  <a href="#about">
    <MagicButton 
